  ...
  return (
    <div className="text-center text-[#ADB7BE] mb-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        ...
        <Link href="https://github.com/mk-backend" className="text-white hover:text-indigo-300 underline">
          GitHub
        </Link>
        <span>&amp;</span>
        <Link href="https://gitlab.com/mk-backend" className="text-white hover:text-indigo-300 underline">
          GitLab
        </Link>
      </div>
    </div>
